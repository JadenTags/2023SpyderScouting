...
async function activateDivButtons(divId) {
    await waitGlobalData();
    
    var buttons = Array.from(document.getElementById(divId).getElementsByClassName("sidebarButton"));
    ...
    buttons = Array.from(document.getElementById(divId).getElementsByClassName("button"));
    ...
    buttons = Array.from(document.getElementById(divId).getElementsByClassName("subNavButton"));
    ...
    buttons = Array.from(document.getElementById(divId).getElementsByClassName("pushButton"));
    ...
    buttons = Array.from(document.getElementById(divId).getElementsByClassName("groupedButton"));
