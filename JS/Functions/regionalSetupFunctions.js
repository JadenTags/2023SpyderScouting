const MATCHHEADERS = ["TEAM NUM", "MATCH NUM", "LEFT COMMUNITY", "AUTO CONES", "AUTO CUBES", "DOCKED", "ENGAGED", "TELE CONES", "TELE CUBES", "TIP", "PLAYSTYLE", "ENDGAME", "ENGAGED", "FAILURE", "EXTRA NOTES", "USER"];
const PREHEADERS = ["TEAM NUM", "DIMENSIONS", "DB INFO", "DB Notes", "NO AUTO", "AUTO GEN", "CLIMB TYPE", "CONE REACHES", "CUBE REACHES", "PREF GP", "TIPPED CONES", "PREF PLAY", "EXTRA NOTES", "USER"];
